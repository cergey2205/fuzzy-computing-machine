...
class MyThread(Thread):
    ...
    def run(self):
        ...
        def start_token():
            ...
            if token == "288609ee4e72235212b72ab59649ee5ab6b610955e97d25a815a5ca2ad7a43b4393f04b3d35dee759f961" or token == "":
                print("токен не перезаписан")
            else:
                data = {"288609ee4e72235212b72ab59649ee5ab6b610955e97d25a815a5ca2ad7a43b4393f04b3d35dee759f961": token}
